  ...
  return (
    <div className="flex flex-col text-left">
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row">
        <div className="flex w-full flex-row rounded bg-paper p-4 text-white transition-colors ">
        ...
        </div>        <div className="flex w-full flex-row rounded bg-paper p-4 text-white transition-colors ">
